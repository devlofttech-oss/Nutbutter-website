export const ABOUT_HERO = {
  ...
  title: 'Our Story',
  subtitle: 'Stone-ground for purity, shaped by tradition, and made for the everyday ritual of real food.',
  image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuCwyD6X4w3QuFWhLaUHrlJmQhA8bie2x3opoYKPS1tFQM7mXeCxVQB60kH6NBT2PjRSb0Afg_ny0G6AJNdkxKaTffxVzrg6JU-wX2Vjfi3EC5a3OD_3cxd_e2wgLVIu7Bn34yVCY6QTfjZi9n1yYQi-H5QfJf5sVBBULIkLPFmEqHi9jQ9KNNSrzhTUk7A-X6FtEiBGVSJTs0Uqb2AAZ0UPMGGQrce1gzAQlpX__yEPALDe4xHNbXal6R3Tia-OjjI1_sfQx30XGrc',
}
...
export const MISSION_VISION = [
  {
    icon: 'lightbulb',
    title: 'Our Mission',
    body: 'To fuel conscious living through single-origin ingredients, slow craft, and transparent nutrition.',
  },
  {
    icon: 'visibility',
    title: 'Our Vision',
    body: 'A pantry where food is pure, pleasurable, and honest in every spoonful.',
  },
]
...
export const PROCESS_STEPS = [
  {
    number: '01',
    title: 'Sourcing',
    body: 'Direct-trade sourcing from generational family farms in premium growing regions.',
  },
  {
    number: '02',
    title: 'Slow-Roasting',
    body: 'Low-temperature roasting unlocks natural oils without scorching the flavor.',
  },
  {
    number: '03',
    title: 'Stone-Grinding',
    body: 'Granite millstones grind each batch for silkiness and natural separation.',
  },
  {
    number: '04',
    title: 'Small-Batch',
    body: 'Each jar is filled in focused batches for quality, freshness, and consistency.',
  },
]
...
export const QUALITY_PROMISES = [
  {
    ...
    body: 'Nothing but nuts and a thoughtful pinch of sea salt.',
  },
  {
  ...
  },
  {
    icon: 'nature_people',
    title: 'Sustainable',
    body: 'Regenerative practices that respect soil, growers, and harvest cycles.',
  },
]
