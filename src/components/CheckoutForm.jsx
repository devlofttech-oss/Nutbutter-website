      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-md">
        {CUSTOMER_FIELDS.map((field) => (
          <label key={field.name} className={`space-y-xs ${field.wide ? 'md:col-span-2' : ''}`}>
            ...
            <input
              className={`w-full bg-surface-container border focus:outline-none focus:ring-2 focus:ring-secondary/20 rounded-lg px-4 md:px-md py-3 md:py-sm text-base md:text-body-md ${
