  ...
  return (
    <div className="bg-background text-on-surface min-h-screen flex flex-col">
      ...
      <main className="flex-grow max-w-7xl mx-auto w-full px-4 sm:px-6 md:px-12 py-12 md:py-xl">
        <section className="bg-surface-container rounded-xl border border-outline-variant p-8 md:p-xl text-center">
          <h1 className="font-serif text-4xl md:text-headline-xl text-primary mb-sm">Page Not Found</h1>
